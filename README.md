...
![Analytics dashboard](docs/screenshots/home.jpg)

| Advanced inventory table | Cash-flow forecast |
| :---: | :---: |
| ![Inventory](docs/screenshots/inventory.jpg) | ![Cash flow](docs/screenshots/cashflow.jpg) |

| Profit & categories | Partner settle-up |
| :---: | :---: |
| ![Profit](docs/screenshots/profit.jpg) | ![Partners](docs/screenshots/socios.jpg) |

| Order builder | Order detail |
| :---: | :---: |
| ![New Order](docs/screenshots/novo-pedido.jpg) | ![Order detail](docs/screenshots/order-detail.jpg) |

| Orders list | On the phone |
| :---: | :---: |
| ![Orders](docs/screenshots/orders.jpg) | <img src="docs/screenshots/home-mobile.jpg" width="240" alt="Home on mobile" /> |
