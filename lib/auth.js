...
// Por defeito, em produção, o cookie de sessão só viaja por HTTPS. Em rede
// local sem HTTPS (aceder pelo IP do PC a partir do telemóvel) os browsers
// recusam cookies "secure", o que parte o login. Define COOKIE_INSEGURO=1
// nesse caso. Num domínio com HTTPS, deixa por desligar (mais seguro).
const cookieSeguro =
  process.env.NODE_ENV === "production" && process.env.COOKIE_INSEGURO !== "1";
